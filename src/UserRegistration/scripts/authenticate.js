...
const signUp_url = 'https://www-automobilepro.herokuapp.com/hci.api/users/registerUser';
const login_url = 'https://www-automobilepro.herokuapp.com/hci.api/user/login';
var counter = 0;
var user = [];
