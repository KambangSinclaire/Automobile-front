...
const url = "https://www-automobilepro.herokuapp.com/hci.api/products";
let Allproducts;
    ...
    $.get(url, (products, error) => {
        ...
        if (error === "success") {
            ...
            products.forEach((product, i) => {
                ...
                div.appendChild(img);
                div.style.hover = `${products[i].name}`;
                row.append(div);
            });
            ...
            openImg.forEach((img, i) => {
                img.addEventListener('click', (event) => {
                    ...
                    localStorage.setItem('ssn', JSON.stringify(Allproducts[i].ssn));
